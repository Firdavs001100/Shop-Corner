...
export class MemberResolver {
	...
	@Mutation(() => Member)
	public async login(@Args('input') loginInput: LoginInput): Promise<Member> {
	...
	public async checkAuthRoles(@AuthMember() authMember: Member): Promise<string> {
		console.log('Mutation: updateMember');
		return await `Hi ${authMember.memberNick}, you're ${authMember.memberType} (memberId: ${authMember._id})`;
	}
